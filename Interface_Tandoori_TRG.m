...
function Repertoire_Callback(hObject, eventdata, handles)
    Repertoire=uigetdir('C:\Users\Plasmas\Desktop');
...
%% ================================ Démarrer la comparaison ================================
    function pushbutton1_Callback(hObject, eventdata, handles)
         ...
         %% HMDSO
         HMDSOMin=str2double(get(handles.FluxHMDSO,'String'));
         HMDSOMax=str2double(get(handles.FacteurHMDSO,'String'));
         HMDSOPts=str2double(get(handles.PointHMDSO,'String')); 
         
         InfoHMDSO=[HMDSOMin HMDSOMax HMDSOPts];
...
%             
         ...
         %% Execution du code
         tic %timer
         Calcul_Te_TRG_ViaInterface(Overwrite,InfoGraphes,InfoTe,InfoNe,InfoHMDSO,filetype,Tg,P_tot,l,FctRep,ChoixErreur,ChoixHautePression,ChoixAutoabs,Commentaire,flow,exposant,ChoixDimension,sig_l); 
         cd(old);
         toc %fin du timer
