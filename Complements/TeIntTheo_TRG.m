...
% depopulation1s=Depop2p+DepopMix-PopMix+DepopSuperelestique+DepopIonisation + 2^(0)*(DepopNeutre)-PopUpDown;
...
% n1sX(2)=n1sX(2)*Thetaij_1s(2); %réduire résonants par facteur auto-abs
% n1sX(4)=n1sX(4)*Thetaij_1s(4); %réduire résonants par facteur auto-abs
densite1s(t,:)=n1sX;
